...
from ipi.engine.motion import Motion, Dynamics, Replay, GeopMotion, NEBMover, DynMatrixMover, MultiMotion, AlchemyMC, AlKMC
...
class InputMotionBase(Input):
    ...
    attribs = {"mode": (InputAttribute, {"dtype": str,
                                         ...
                                         "options": ['vibrations', 'minimize', 'replay', 'neb', 'dynamics', 'alchemy', 'al-kmc', 'dummy']})}
